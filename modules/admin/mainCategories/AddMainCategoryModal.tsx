...
import { CategoryDataType, MainCategoryType } from '../../products/products.types'
import { mainCategoryInitialValues, mainCategoryValidationSchema } from '../../products/products.utils'
import { getCategories, createMainCategory } from '../../products/products.service'
...
export const AddMainCategoryModal: FC<AddModalProps> = ({
    isOpen,
    onClose,
    handleReload,
}) => {
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            const res = await createMainCategory(formData);
            ...
            if (res.success) {
                ...
                toast.error(res.message || "Failed to create main category.");
            }
        } catch (error) {
            console.error("Main Category Submission Error:", error);
            toast.error("An error occurred while creating the main category.");
        } finally {
            setIsLoading(false);
            setSubmitting(false);
        }
    ...
    return (
        ...
        >
            <Formik
                initialValues={mainCategoryInitialValues}
                validationSchema={mainCategoryValidationSchema}
                onSubmit={handleSubmit}
            >
                {({ isSubmitting, values, setFieldValue }: FormikProps<MainCategoryType>) => (
                    <Form>
